...
export default function AnalyticsPage({ params }: PageProps) {
    ...
    return (
        <div className="min-h-screen bg-[#0f0f16] text-white p-8 pb-32">
            <div className="max-w-6xl mx-auto">
                <Link href="/admin" className="flex items-center text-gray-400 hover:text-white mb-6 w-fit">
                    <ArrowLeft size={18} className="mr-2" /> Back to Dashboard
                </Link>

                <div className="mb-8">
                    <h1 className="text-3xl font-bold mb-2">{data.examTitle}</h1>
                    <p className="text-gray-400">Exam Analytics & Student Results</p>
                </div>
