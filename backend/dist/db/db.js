...
exports.db = exports.ensureDbInitialized = void 0;
...
const seedCurriculum = async (client) => {
    ...
    if (parseInt(res.rows[0].count) === 0) {
        ...
        for (const lesson of curriculum_js_1.CURRICULUM) {
            await client.query(`
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
function mapRowToExamSubmission(row) {
    return {
        id: row.id,
        examId: row.exam_id,
        studentName: row.student_name,
...
exports.db = {
    ...
    getLessons: async (includePrivate = false) => {
        await (0, exports.ensureDbInitialized)();
    ...
    // --- SUBMISSIONS & POINTS ---
    submitAttempt: async (submission) => {
        await (0, exports.ensureDbInitialized)();
        const query = `
    ...
    getStudentPoints: async (studentName) => {
        await (0, exports.ensureDbInitialized)();
        const query = `
    ...
    getStudentProgress: async (studentName) => {
        await (0, exports.ensureDbInitialized)();
        const query = `
    ...
    submitExamAttempt: async (submission) => {
        await (0, exports.ensureDbInitialized)();
